...
💡 I enjoy exploring the connection between structure and creativity — whether it's through clean code, sound design, or solving real-world problems with tech. I believe that well-crafted software, like music, should be both functional and expressive.

🚀 I'm passionate about continuous learning and always striving to build better, smarter solutions. Currently, I’m diving deeper into frontend development with **React**, aiming to become a well-rounded full-stack developer.
...
- **EliteMCServers** – A full-featured Java Spring Boot web platform for discovering and managing Minecraft servers.  
  ...
  🔗 [View on GitHub](https://github.com/fjedrzejewski062/EliteMCServers)

- **BeatHelper** – A web application for music creators designed to support the beatmaking and idea-generation process.  
  Built with Java Spring and Thymeleaf, it allows users to randomly generate BPM and musical keys, with smart suggestions based on the Camelot Wheel for harmonic mixing. It’s a simple but powerful tool to spark creativity and keep sessions flowing.  
  🔗 [View on GitHub](https://github.com/fjedrzejewski062/beathelper)
...
`Spring Boot` `Hibernate` `JUnit` `Mockito` `AssertJ`
...
📫 Always open to feedback, collaboration, or a quick chat about tech!
-->
